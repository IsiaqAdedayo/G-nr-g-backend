...
async function main() {
    console.log(...oo_oo(`1927364962_358_2_358_49_4`, '🧵 Seeding Gúnrégé database...\n'));
    for (const brand of BRANDS) {
        ...
        console.log(...oo_oo(`1927364962_367_4_367_43_4`, `  ✓ Brand: ${brand.name}`));
    }
    for (const model of MODEL_PRESETS) {
        ...
        console.log(...oo_oo(`1927364962_377_4_377_77_4`, `  ✓ Model: ${model.name} (${model.build}, ${model.gender})`));
    }
    for (const garment of GARMENTS) {
        ...
        console.log(...oo_oo(`1927364962_397_4_397_47_4`, `  ✓ Garment: ${garment.name}`));
    }
    ...
    console.log(...oo_oo(`1927364962_409_2_409_31_4`, '  ✓ Guest user'));
    console.log(...oo_oo(`1927364962_411_2_411_36_4`, '\n🧵 Seed complete!'));
}
main()
    .catch((e) => {
    console.error(...oo_tx(`1927364962_416_4_416_36_11`, 'Seed failed:', e));
    process.exit(1);
})
    .finally(async () => {
