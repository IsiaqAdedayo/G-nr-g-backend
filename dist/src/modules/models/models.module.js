...
const models_controller_js_1 = require("./models.controller.js");
let ModelsModule = class ModelsModule {
};
exports.ModelsModule = ModelsModule;
exports.ModelsModule = ModelsModule = __decorate([
    (0, common_1.Module)({
        controllers: [models_controller_js_1.ModelsController],
        providers: [models_service_js_1.ModelsService],
        exports: [models_service_js_1.ModelsService],
    })
], ModelsModule);
