...
// ── Garments (§31 — 8 garments) ──────────────────────────────────────────
const GARMENTS = [
  {
    brandId: 'homme-plisse',
    name: 'Pleated Crewneck & Wide-Leg Trousers',
    description:
      'Iconic micro-pleated technical fabric with sculptural drape and natural fold memory.',
    price: 240000,
    currency: 'NGN',
    category: 'Tops',
  ...
  },
  {
    ...
    description:
      'Double-breasted unstructured linen blazer paired with wide pleated trousers.',
    price: 145000,
    currency: 'NGN',
    category: 'Outerwear',
    images: [
  ...
  },
  {
    ...
    description:
      'One-shoulder sculptural evening dress in metallic-sheen molten silk.',
    price: 120000,
    currency: 'NGN',
    category: 'Dresses',
    images: [
  ...
  },
  {
    ...
    description:
      'High-neck pleated technical zip jacket with articulated raglan sleeve contours.',
    price: 310000,
    currency: 'NGN',
    category: 'Outerwear',
  ...
  },
  {
    ...
    description:
      'Crisp Oxford poplin with extended collar points and mother of pearl buttons.',
    price: 38000,
    currency: 'NGN',
    category: 'Tops',
    images: [
  ...
  },
  {
    ...
    description:
      'Sleek sleeveless top and pressed-crease cigarette trousers in wool-silk blend.',
    price: 85000,
    currency: 'NGN',
    category: 'Trousers',
    images: [
  ...
  },
  {
    ...
    description:
      'Supple full-grain calfskin leather jacket with asymmetrical silver hardware.',
    price: 195000,
    currency: 'NGN',
    category: 'Outerwear',
    images: [
  ...
  },
  {
    ...
    description:
      'Vintage-washed indigo denim with generous thigh and relaxed ankle.',
    price: 65000,
    currency: 'NGN',
    category: 'Jeans',
    images: [
  ...
  for (const garment of GARMENTS) {
    ...
    await prisma.garment.upsert({
      ...
      create: {
        id,
        ...garment,
        colors: garment.colors as any,
        garmentMeasurements: garment.garmentMeasurements as any,
      },
    });
